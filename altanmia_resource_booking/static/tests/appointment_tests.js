        ...
        this.data = {
            ...
            'calendar.event': {
                fields: {
                    ...
                    book_profile_id: {string: 'Appointment Type', type: 'many2one', relation: 'calendar.appointment.type'},
                },
                records: [{
                    id: 1,
                    user_id: session.uid,
            ...
            'calendar.appointment.slot': {
                fields: {
                    book_profile_id: {type: 'many2one', relation: 'calendar.appointment.type'},
