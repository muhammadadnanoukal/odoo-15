...
class BookingPortal(portal.CustomerPortal):
    ...
    @http.route([
        '/my/booking',
        '/my/booking/page/<int:page>',
    ], type='http', auth='user', website=True)
    def portal_my_booking(self, page=1, sortby=None, filterby=None, search=None, search_in='all', groupby='none', **kwargs):
        ...
        return request.render("altanmia_resource_booking.portal_my_booking", values)
