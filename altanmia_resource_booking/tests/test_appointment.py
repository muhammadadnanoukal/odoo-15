...
class AppointmentTest(AppointmentCommon):
    ...
    def test_generate_slots_recurring(self):
        ...
        with freeze_time(self.reference_now):
            slots = apt_type._get_booking_slots('Europe/Brussels')
    ...
    def test_generate_slots_recurring_UTC(self):
        ...
        with freeze_time(self.reference_now):
            slots = apt_type._get_booking_slots('UTC')
    ...
    def test_timezone_delta(self):
        ...
        with freeze_time(self.reference_now):
            slots = apt_type.sudo()._get_booking_slots('Australia/West', employee=None)
