...
class AppointmentTest(AppointmentPerformanceCase):
    ...
    def test_get_appointment_slots_custom(self):
        ...
        with self.mockAppointmentCalls(), \
            ...
            t0 = time.time()
            res = apt_type_custom_bxls._get_booking_slots('Europe/Brussels', reference_date=self.reference_now)
            t1 = time.time()
    ...
    def test_get_appointment_slots_website_whours(self):
        ...
        with self.mockAppointmentCalls(), \
            ...
            t0 = time.time()
            res = apt_type._get_booking_slots('Europe/Brussels', reference_date=self.reference_now)
            t1 = time.time()
